function json_encode(e){var t,a=this.window.JSON;try{if("object"==typeof a&&"function"==typeof a.stringify){if(t=a.stringify(e),void 0===t)throw new SyntaxError("json_encode");return t}var o=e,s=function(e){var t=/[\\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,a={"\b":"\\b","	":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};return t.lastIndex=0,t.test(e)?'"'+e.replace(t,function(e){var t=a[e];return"string"==typeof t?t:"\\u"+("0000"+e.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+e+'"'},i=function(e,t){var a="",o="    ",n=0,l="",c="",r=0,d=a,u=[],f=t[e];switch(f&&"object"==typeof f&&"function"==typeof f.toJSON&&(f=f.toJSON(e)),typeof f){case"string":return s(f);case"number":return isFinite(f)?String(f):"null";case"boolean":case"null":return String(f);case"object":if(!f)return"null";if(this.PHPJS_Resource&&f instanceof this.PHPJS_Resource||window.PHPJS_Resource&&f instanceof window.PHPJS_Resource)throw new SyntaxError("json_encode");if(a+=o,u=[],"[object Array]"===Object.prototype.toString.apply(f)){for(r=f.length,n=0;r>n;n+=1)u[n]=i(n,f)||"null";return c=0===u.length?"[]":a?"[\n"+a+u.join(",\n"+a)+"\n"+d+"]":"["+u.join(",")+"]",a=d,c}for(l in f)Object.hasOwnProperty.call(f,l)&&(c=i(l,f),c&&u.push(s(l)+(a?": ":":")+c));return c=0===u.length?"{}":a?"{\n"+a+u.join(",\n"+a)+"\n"+d+"}":"{"+u.join(",")+"}",a=d,c;case"undefined":case"function":default:throw new SyntaxError("json_encode")}};return i("",{"":o})}catch(n){if(!(n instanceof SyntaxError))throw new Error("Unexpected error type in json_encode()");return this.php_js=this.php_js||{},this.php_js.last_error_json=4,null}}
